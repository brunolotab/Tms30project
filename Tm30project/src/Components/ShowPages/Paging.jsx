        ...
        <Div>
            <div className='flex justify-around my-[1rem] w-[100%]'>
                <div className='flex' style={{ flexDirection: 'column' }} >
                    ...
                    <div>
                        {toggle && (<div className='ml-4 border-2 p-1 w-10 text-center shadow-xl'>{
                            tabs.map((page, i) => {
                                return (
                                    <div key={i}
                                        ...
                                        className='hove'
                                    >
                                        <div onClick={() => { setPostperpage(page); setToggle(false) }} style={{ borderBottom: '1px solid #dddd', width: '3rem' }} className={page === postperpage ? 'inactive' : ''}>{page}</div>
                                    </div>
                                )
                            })}
                        </div>)
